  ...
  return (
    <div className="flex flex-col items-center text-black rounded-xl shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 duration-300 text-center gap-2">
      ...
      <h3 className="text-xl font-semibold text-white">{name}</h3>
        <p className='text-gray-100 text-md font-medium lowercase'>The trainers here are exceptional and the facilities are top-notch. I've achieved my fitness goals faster than I expected. The supportive community makes every workout enjoyable.</p>
    </div>
  );
};
